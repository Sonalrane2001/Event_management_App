 ...
 * @author AVCOE
 */
public class signupfordmin extends javax.swing.JFrame {

    /**
     * Creates new form signupfordmin
     */
    public signupfordmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("       For Student Sign Up");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(signupfordmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new signupfordmin().setVisible(true);
            }
        });
    }
